...
```
Shipped Doc Hub — a local-first launcher for docs & planning.
...
```
Doc Hub stays free. Visual Ship Gate is the $15 pack:
...
```
I built Doc Hub: a desktop launcher for solo developers who want planning and docs without a SaaS account.
...
```
Show HN: Doc Hub – local-first docs & planning launcher (no cloud required)
...
```
Зробив Doc Hub — локальний лаунчер для доків і планування.
