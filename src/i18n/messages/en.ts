...
export const en = {
  ...
  benchmark: {
    ...
    lede: "Discriminative Docs MD vs Doc Memory MCP — handoff, continuity, safety, synthesis, plus negative controls. Saturated Phase D parity lives under History.",
    ...
    labelBefore: "before",
    labelAfter: "after",
    nowMeta: "Phase E discriminative · Docs MD vs MCP · live A/E capsules · locked scoring",
    fairCallout:
      "Anti-tender bake-off: both arms can reach Docs; class F can tie. Not empty-chat starvation.",
    nowNote:
      "Advantage-pool A–E: Docs MD 3/5 PASS, MCP 5/5 (A PARTIAL→PASS, E FAIL→PASS via live capsules). Class F ×2 PASS/PASS. B/C/D null. Evaluator-conducted design artifacts.",
    deltaTitle: "Deltas (MCP − MD)",
    ctaDownload: "Download Doc Hub",
    ctaNote: "Same local launcher the discriminative suite measures against.",
    statPassRate: "PASS rate",
    statAdvPass: "Advantage-pool PASS",
    statAllPass: "All cards PASS",
    allPassNote: "Includes class F negative controls (expected ties).",
    ...
    parityNote:
      "On memory-only prior-state cards (A/E) MCP recovers decisions Docs-only miss; F controls do not invent a win.",
    costTitle: "Cost vs quality",
    costX: "Mean extra lookups",
    costY: "PASS %",
    costNote:
      "MCP wins more PASS on A–E; mean extras still slightly higher overall (F is costly).",
    perTaskTitle: "Per-task (n under the rates)",
    perTaskLede: "Seven Phase E cards — classes A–F; sample size stays visible.",
    ...
    armMdTitle: "Docs (MD)",
    armMdBody:
      "AGENTS/CLAUDE + Read/Grep on Docs/** and the repo. No Doc Memory MCP — no capsule/.dochub gold reads.",
    armMcpTitle: "Doc Memory (MCP)",
    armMcpBody:
      "Same prompt. First tool: doc_session (often with capsule id), then scoped Doc Hub tools (+ repo reads).",
    walkTitle: "What happens",
    walkLede: "Two discriminative cards — live Work Capsules on A/E.",
    walkE1Title: "Handoff continue (class A)",
    walkE1Prompt:
      "Continue multi-command board work after a prior session. Smallest next steps only — no distributed consensus.",
    walkE1Plain:
      "Docs-only re-opened full P27 LOCK (WAL/busy_timeout) as primary work. PARTIAL.",
    walkE1Dm:
      "Live capsule: LOCK already done → IDENTITY + lease_claim only. PASS.",
    walkE1Takeaway:
      "Memory-only prior state is the variable — not “Docs unreachable.”",
    walkE2Title: "Continuity Part 2 (class E)",
    walkE2Prompt:
      "Part 2 after Part 1 chose advisory leases and rejected exclusive flock.",
    walkE2Plain:
      "Without Part 1 packet, re-litigated flock as a hardening option. FAIL.",
    walkE2Dm:
      "Live capsule kept X (leases) and blocked Y (flock). PASS.",
    walkE2Takeaway:
      "Capsule/board continuity is where MCP can change outcomes without starving Docs.",
    ...
    caseE001Title: "Handoff continue (A)",
    caseE002Title: "Stale vs ADR (B)",
    caseE003Title: "Fence before schema (C)",
    caseE004Title: "Runtime truth synthesis (D)",
    caseE005Title: "Continuity Part 2 (E)",
    caseE006Title: "WAL + busy_timeout (F)",
    caseE007Title: "Quarantine fence (F)",
    historyLede:
      "Saturated Phase D parity, starvation demo, packet recall, and efficiency R&D. Discriminative Phase E is on Now.",
    ...
    phaseEF: "Class F (negative)",
    phaseETie: "tie",
    phaseELive: "Live A/E capsules",
    phaseELiveYes: "Yes (wave 1b)",
    phaseENote:
    ...
    lim1: "Now: Phase E discriminative Docs MD vs MCP (A–F). Live capsules on A/E. Evaluator-conducted design artifacts.",
    lim2: "n = 7 Phase E; not blind. Class F negative controls mandatory.",
    lim3: "History: Phase D saturated PASS/PASS, Phase C starvation, R1/post-fix efficiency.",
    lim4: "No external traction or willingness-to-pay evidence on this page.",
    footSnapshot:
      "Snapshot 2026-08-06 · Phase E on Now · Phase D/C in History · Full artifacts in the Doc Hub grant corpus.",
    footBack: "← Back to Doc Hub",
    footPress: "Press kit",
    footDownload: "Download",
  },
