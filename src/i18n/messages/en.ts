...
export const en = {
  ...
  benchmark: {
    ...
    lede: "Same project, Docs as source of truth — Read/Grep Markdown vs Doc Memory MCP. Honest rates: outcome parity, packet recall, and access cost. Empty-chat starvation lives under History.",
    ...
    fairCallout:
      "Fair bake-off: both arms can reach Docs. Not “empty chat vs product.”",
    nowNote:
      "PASS/crit from Phase B pilot (n=5). Recall panel from Phase A packets (n=20). CB-004/CB-006 excluded until a Docs MD arm exists.",
    deltaTitle: "Deltas (MCP − MD)",
    ctaDownload: "Download Doc Hub",
    ctaNote: "Same local launcher the fair suite measures against.",
    ...
    parityNote: "Outcome parity on Docs-saturated dogfood — MCP does not “win PASS” here.",
    costTitle: "Cost vs quality",
    costX: "Mean extra lookups",
    costY: "PASS %",
    costNote:
      "Same PASS; MCP cost more follow-up fetches on this pilot (efficiency work continues).",
    perTaskTitle: "Per-task (n under the rates)",
    perTaskLede: "Every PASS is one of five cards — sample size stays visible.",
    ...
    armMdTitle: "Docs (MD)",
    armMdBody:
      "AGENTS/CLAUDE + Read/Grep on Docs/** and the repo. No Doc Memory MCP — filesystem access to the same SoT.",
    armMcpTitle: "Doc Memory (MCP)",
    armMcpBody:
      "Same prompt. First tool: doc_session, then scoped Doc Hub tools (+ repo reads when needed).",
    walkTitle: "What happens",
    walkLede: "Two of the five fair prompts — MD Grep path vs MCP session.",
    ...
    historyLede:
      "Starvation demo, packet recall, and efficiency R&D. Not required for the fair Docs MD vs MCP story.",
    ...
    phaseCDefer:
      "CB-004 / CB-006 appear here only — excluded from Now until a Docs MD arm is scored.",
    ...
    barDm: "Doc Memory",
    phaseBMeta: "Same as Now fair arms · Baseline = Docs MD · Doc Hub = MCP",
    ...
    phaseBNote:
      "These runs power the Now tab. PASS/PASS with Docs reachable either way.",
    ...
    lim1: "Now: Docs MD = AGENTS + Read/Grep; MCP = doc_session first. Same dogfood Docs SoT.",
    lim2: "n = 5 fair suite; not blind; design artifacts only. Gold already in Docs.",
    lim3: "History: empty-chat starvation (Phase C), R1/post-fix efficiency — not fair outcome wins.",
    lim4: "No external traction or willingness-to-pay evidence on this page.",
    footSnapshot:
      "Snapshot 2026-08-06 · Phase D fair bake-off · Full artifacts in the Doc Hub grant corpus.",
    footBack: "← Back to Doc Hub",
    footPress: "Press kit",
    footDownload: "Download",
  },
