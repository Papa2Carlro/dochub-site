...
export const uk: Messages = {
  ...
  benchmark: {
    ...
    lede: "Discriminative Docs MD vs Doc Memory MCP — handoff, continuity, safety, synthesis + negative controls. Насичений Phase D parity — у History.",
    ...
    fairCallout:
      "Анти-тендер: обидві руки дістають до Docs; class F може tie. Не empty-chat starvation.",
    nowNote:
      "Advantage-pool A–E: Docs MD 3/5 PASS, MCP 5/5 (A PARTIAL→PASS, E FAIL→PASS через live capsules). Class F ×2 PASS/PASS. B/C/D null. Evaluator-conducted design-артефакти.",
    deltaTitle: "Дельти (MCP − MD)",
    ctaDownload: "Завантажити Doc Hub",
    ctaNote: "Той самий локальний лаунчер, що в discriminative suite.",
    statPassRate: "PASS rate",
    statAdvPass: "Advantage-pool PASS",
    statAllPass: "PASS по всіх картках",
    allPassNote: "Включно з class F negative controls (очікувані ties).",
    ...
    parityNote:
      "На memory-only prior-state (A/E) MCP відновлює рішення, які Docs-only пропускає; F не вигадує перемогу.",
    costTitle: "Вартість vs якість",
    costX: "Середні зайві пошуки",
    costY: "PASS %",
    costNote:
      "MCP більше PASS на A–E; середні extras трохи вищі загалом (F дорогий).",
    perTaskTitle: "По задачах (n під rates)",
    perTaskLede: "Сім карток Phase E — класи A–F; sample size видно.",
    ...
    armMdTitle: "Docs (MD)",
    armMdBody:
      "AGENTS/CLAUDE + Read/Grep по Docs/** і репо. Без Doc Memory MCP — без capsule/.dochub gold reads.",
    armMcpTitle: "Doc Memory (MCP)",
    armMcpBody:
      "Той самий промпт. Перший інструмент: doc_session (часто з capsule id), далі scoped Doc Hub tools (+ репо).",
    walkTitle: "Що відбувається",
    walkLede: "Дві discriminative картки — live Work Capsules на A/E.",
    walkE1Title: "Handoff continue (клас A)",
    walkE1Prompt:
      "Продовжити multi-command board після попередньої сесії. Лише найменші next steps — без distributed consensus.",
    walkE1Plain:
      "Docs-only знову відкрив повний P27 LOCK (WAL/busy_timeout) як основну роботу. PARTIAL.",
    walkE1Dm:
      "Live capsule: LOCK уже зроблено → лише IDENTITY + lease_claim. PASS.",
    walkE1Takeaway:
      "Змінна — memory-only prior state, не «Docs недоступні».",
    walkE2Title: "Continuity Part 2 (клас E)",
    walkE2Prompt:
      "Part 2 після того, як Part 1 обрав advisory leases і відхилив exclusive flock.",
    walkE2Plain:
      "Без Part 1 пакета знову розглядав flock як hardening. FAIL.",
    walkE2Dm:
      "Live capsule зберіг X (leases) і заблокував Y (flock). PASS.",
    walkE2Takeaway:
      "Capsule/board continuity — де MCP може змінити outcomes без starvation Docs.",
    ...
    historyLede:
      "Насичений Phase D parity, starvation demo, packet recall і efficiency R&D. Discriminative Phase E — на Зараз.",
    ...
    lim1: "Зараз: Phase E discriminative Docs MD vs MCP (A–F). Live capsules на A/E. Evaluator-conducted design-артефакти.",
    lim2: "n = 7 Phase E; не сліпий. Class F negative controls обов’язкові.",
    ...
    footSnapshot:
      "Знімок 2026-08-06 · Phase E на Зараз · Phase D/C у History · Повні артефакти в grant-корпусі Doc Hub.",
    footBack: "← Назад до Doc Hub",
    footPress: "Press kit",
    footDownload: "Завантажити",
  },
