...
export const uk: Messages = {
  seo: {
    ...
    benchmarkTitle: "Context Benchmark — звичайний чат vs Doc Memory",
    benchmarkDescription:
      "Ті самі п’ять інженерних промптів: звичайний чат без інструментів vs Doc Hub Doc Memory. Walkthroughs, outcomes і R&D-апдейти — лише внутрішні технічні свідчення.",
  },
  nav: {
  ...
  benchmark: {
    ...
    lede: "Ті самі п’ять інженерних промптів. Одна рука — звичайний чат без інструментів. Інша стартує з Doc Memory. Ми оцінюємо, чи жорсткі правила проєкту доживають до дизайну — не чи Doc Hub пише кращий код, і не ринкову тягу.",
    badgePrompts: "Ті самі промпти",
    badgePromptsEm: "n=5",
    badgePlain: "Звичайний чат",
    badgePlainEm: "0 PASS",
    badgeDm: "Doc Memory",
    badgeDmEm: "5/5 PASS",
    metricPlainLabel: "Звичайний чат (без інструментів)",
    metricPlainValue: "0 PASS",
    metricPlainNote: "4 FAIL · 1 PARTIAL — вигадує заборонені дизайни",
    metricDmLabel: "Чат з Doc Memory",
    metricDmValue: "5/5 PASS",
    metricDmNote: "Ті самі промпти · зафіксований critical-constraint скоринг",
    metricContrastLabel: "Що змінилось",
    metricContrastValue: "Контекст",
    metricContrastNote: "Політика проєкту доступна vs порожній чат — не Grep vs Grep",
    calloutStrong: "Як це читати.",
    calloutBody:
      "Головна історія: порожній чат vs Doc Memory на однакових промптах. Агент, у якого вже є повний Read/Grep по репо, теж може PASS багато з цих історичних задач — те порівняння нижче в Updates, не в заголовку.",
    armsTitle: "Дві руки",
    armsLede: "Однакові промпти з корпусу. Різний вхід у контекст.",
    armPlainTitle: "Звичайний чат — без інструментів",
    armPlainBody:
      "Лише текст задачі. Немає Read, Grep, Shell чи Doc Hub MCP. Модель може опиратися на промпт і свої priors — нічого з Docs/, AGENTS.md чи репозиторію.",
    armDmTitle: "Чат з Doc Memory",
    armDmBody:
      "Той самий промпт. Перший інструмент: doc_session. Далі scoped Doc Hub tools (route, section, search, fences…) і за потреби звичайні читання репо. Правила проєкту приходять з індексованих Docs і ADR.",
    walkTitle: "Що відбувається на одному прикладі",
    walkLede:
      "Два walkthrough з пілотного набору. Повні описи покривають усі п’ять кейсів.",
    labelPlain: "Звичайний чат",
    labelDm: "Doc Memory",
    walk1Title: "Спільна локальна дошка",
    walk1Prompt:
      "Промпт: узгодити Tauri, dm, MCP і Python worker на одному .dochub/workspace.sqlite без псування дошки.",
    walk1Plain:
      "Вигадав exclusive lock-файл, hard task locks і майбутній CRDT — і не назвав WAL + busy_timeout, writer stamps чи capsule handoff.",
    walk1Dm:
      "doc_session → multi-command guide + ADR 0004. Відновив LOCK / IDENTITY / HANDOFF і залишив concurrent local writers. PASS.",
    walk1Takeaway:
      "Без інструментів модель вигадує generic locking, що ламає політику Doc Hub. З Doc Memory тягне справжній рецепт.",
    walk2Title: "Unity pin без поломки Doc Hub",
    walk2Prompt:
      "Промпт: вікна Cursor для Unity потребують Doc Hub MCP на Unity-проєкт, не ламаючи існуюче вікно doc-hub.",
    walk2Plain:
      "Захардкодив єдиний global DOC_MEMORY_WORKSPACE pin і сказав операторам перезаписувати спільний mcp.json на кожен switch.",
    walk2Dm:
      "Відновив per-project mcp.json / last_used registry після шумного першого пакета. Співіснування вікон. PASS.",
    walk2Takeaway:
      "«Просто постав global env» ламає multi-window. Doc Memory показує per-project pin.",
    resultsTitle: "Усі п’ять outcomes",
    resultsLede: "Зафіксований critical-constraint скоринг на design-артефактах.",
    thTask: "Задача",
    thPlain: "Plain",
    thDm: "Doc Memory",
    ...
    case011Dm: "PASS",
    resultsFaint:
      "Внутрішні технічні свідчення · знімок 2026-08-05 · рука Doc Memory взята з locked Phase B Doc Hub прогонів",
    updatesTitle: "Updates — історія R&D",
    updatesLede:
      "Опційно для новачків. Раніші руки порівнювали Doc Memory з instruction files і з агентами, у яких уже були інструменти репо, плюс post-fix efficiency probe.",
    coverageTitle: "Покриття — жорсткі правила в першому пакеті",
    coverageBody:
      "20 історичних задач. Пакет instruction files vs Doc Hub session-пакет. Оцінює, чи gold must-know правила з’явились рано — не якість коду.",
    barBaseline: "Instruction files",
    barDocHub: "Doc Hub",
    coverageFaint:
      "+20.6 відсоткових пунктів більше покритих правил · ~64% відносне скорочення промахів",
    outcomesTitle: "Outcomes vs Baseline з інструментами репо",
    outcomesBody:
      "П’ять парних задач агента з дозволеним Read/Grep на Baseline. Той самий фініш — Doc Hub часто коштував більше follow-up пошуків до пізніших фіксів.",
    thResult: "Результат",
    thValue: "Значення",
    ...
    outcomesFaint:
      "Ці задачі часто вже розв’язувались звичайним Read/Grep по репо — тож фінішні скори майже не розвели два режими.",
    efficiencyTitle: "Менше зайвих пошуків після фіксів сесії",
    efficiencyLede:
      "Окремий Doc Hub-only зонд після фіксів routing/session. Не перепис outcome-скорів вище.",
    barPre: "До фіксів",
    barPost: "Після фіксів",
    meanFaint:
      "Середні зайві пошуки 31.4 → 7.6 (−75.8%) · усі п’ять усе ще PASS",
    ...
    lim1: "Plain-рука — лише priors моделі; рука Doc Memory перевикористана з раніших locked прогонів.",
    lim2: "Пілот n = 5; історичні dogfood-задачі; не сліпий; лише design-артефакти.",
    lim3: "PASS/PASS проти Baseline з інструментами репо не скасовує контраст plain vs DM — інше питання.",
